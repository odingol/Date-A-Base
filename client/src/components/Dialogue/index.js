      ...
      prompts: [
        {
          ...
          dialog2: "I’m not sure how I’m going to function() with all of these topics, but my learning method is pretty sound.",
          dialog3: 'I’m just here to let my style cascade on the class!',
          dialog4: "I’m here to learn about databases and go on date-a-bases. Ha Get it?"
        },
        {
          ...
          dialog1: "Very Cool! Maybe sometime you could help me learn about handlebars. I’d really like to impress Hayden.",
          dialog2: "Oh right on! I'm more of a Google Chrome user myself. I take it you took up JS from your mom? ",
          dialog3: "Oh no way! Firefox? That’s pretty cool, although I do have some design ideas that they may want to change.",
          dialog4: "*Ignores them*"
        },
        {
          ...
          dialog1: "Hayden seems like a good <anchor> to have in our group. Just be careful not to push their <buttons>.",
          dialog2: "No thanks, I’m not impressed with your methods().",
          dialog3: "Sure! Let's pull ourselves up from the bootstraps and rock this class!",
          dialog4: "Let’s table this for now, but maybe we could meet up later. What row are you sitting in?"
        },
        {
          ...
          dialog1: "I looked at the rubric and it doesn’t look like we will be working with SQL for a few months. Maybe another time?",
          dialog2: 'You seem really nice and detail oriented but I don’t think this will function() well.',
          dialog3: "I’m sort of looking for someone who is looking to go above and beyond to wow the graders. Sorry.",
